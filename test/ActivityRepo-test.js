...
describe('ActivityRepo', () => {
    ...
    it.skip('should be a function', () => {
		...
		it.skip('should be an instance of ActivityRepo', () => {
			expect(activityRepo).to.be.a.instanceOf(ActivityRepo);
        });

    it.skip('should have access to all the users sleep information', () => {
            expect(activityRepo.data.length).to.equal(60);
        });

    it.skip('should calculate the average numbers of stairs climbed by users on a specific date', () => {
