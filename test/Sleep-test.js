...
describe('Sleep Repository', () => {
  ...
  it.skip('should retrieve sleep hours data', () => {
    expect(sleep.getSleepInfoForSpecificDate("2023/03/01", "hoursSlept")).to.equal(9.6);
  });
  
  it.skip('should retrieve sleep quality data', () => {
    expect(sleep.getSleepInfoForSpecificDate("2023/03/01", "sleepQuality")).to.equal(4.3);
  });
  
  it.skip('should retrieve sleep hours for specified week', () => {
    sleep.hoursSleptInWeek("2023/03/01");
  ...
  it.skip('should retrieve sleep quality for specified week', () => {
    sleep.qualitySleptInWeek("2023/03/01");
