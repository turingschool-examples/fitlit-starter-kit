...
describe('Sleep', () => {
  ...
  it('should return a specific user average Hydration Data for all time even when an argument is passed', () => {
    expect(sleep.getAvgSleepHours('test')).to.equal(37);
  })
  ...
  it('should return a specific user average Hydration Data for all time even when an argument is passed', () => {
    expect(sleep.getAvgSleepQual('test')).to.equal(37);
  })
  ...
  it('should return a specific user Hydration Data over x days if there aren\t 7 days worth of data', () => {
    expect(sleep.getWeeklySleepHours('2019/06/20')).to.deep.equal([42, 46, 33, 20, 45]);
  })
  ...
  it('should return a specific user Hydration Data over x days if there aren\t 7 days worth of data', () => {
    expect(sleep.getWeeklySleepQual('2019/06/20')).to.deep.equal([42, 46, 33, 20, 45]);
  })
