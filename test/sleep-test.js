...
describe('Sleep', function() {
    ...
    it('should return a users average hours of sleep', function() {
    ...
    it('should return the hours slept for a specific day', function() {
        const sleep = new Sleep(sleepSampleData);
        expect(sleep.getHoursForDay(1, '2019/07/03')).to.equal(10.1);
    })

    it('should return sleep quality for a user for a specific day', function() {
        const sleep = new Sleep(sleepSampleData);
        expect(sleep.getQualityForDay(1, '2019/07/03')).to.equal(2.1);
    })

    it('should return sleep hours for a week', function() {
        const sleep = new Sleep(sleepSampleData);
