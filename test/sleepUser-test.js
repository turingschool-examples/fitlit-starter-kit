...
describe('SleepUser', () => {
  ...
  it('should get hours slept for a user daily over the course of a week', () => {
    expect(sleepUser.getDailySleepByWeek("2019/06/24", 'sleepQuality')).to.deep.equal([ { userID: 1, date: '2019/06/17', hoursSlept: 8 },
  { userID: 1, date: '2019/06/18', hoursSlept: 10.4 },
  { userID: 1, date: '2019/06/19', hoursSlept: 10.7 },
  { userID: 1, date: '2019/06/20', hoursSlept: 9.3 },
  { userID: 1, date: '2019/06/21', hoursSlept: 7.8 },
  { userID: 1, date: '2019/06/22', hoursSlept: 7 },
  { userID: 1, date: '2019/06/23', hoursSlept: 7.8 },
  { userID: 1, date: '2019/06/24', hoursSlept: 8 } ]);
  });

  it('should get quality slept for a user daily over the course of a week', () => {
    expect(sleepUser.getDailySleepByWeek("2019/06/24", 'hoursSlept')).to.deep.equal([ { userID: 1, date: '2019/06/17', sleepQuality: 2.6 },
  { userID: 1, date: '2019/06/18', sleepQuality: 3.1 },
  { userID: 1, date: '2019/06/19', sleepQuality: 1.2 },
  { userID: 1, date: '2019/06/20', sleepQuality: 1.2 },
  { userID: 1, date: '2019/06/21', sleepQuality: 4.2 },
  { userID: 1, date: '2019/06/22', sleepQuality: 3 },
  { userID: 1, date: '2019/06/23', sleepQuality: 1.5 },
  { userID: 1, date: '2019/06/24', sleepQuality: 1.3 } ]);
  });

  it('should get average hours slept for a user over the course of any given week', () => {
    expect(sleepUser.getAvgHoursSleepByWeek("2019/06/24")).to.deep.equal(
