...
describe('UserRepository', function() {
  ...
  beforeEach(function() {
    userRepository = new UserRepository(userTestRepository);
  });
  ...
  it('should hold on to all users', function() {
    expect(userRepository.data).to.deep.equal(userTestRepository);
  });

  it('should return a specific users data', function() {
    expect(userRepository.returnUser(1)).to.equal(userTestRepository[0])
  });
