...
describe('User', function() {
    ...
    it('should be able to have a name', function() {
        ...
        expect(user2.name).to.deep.equal("Jarvis Considine")
    })
