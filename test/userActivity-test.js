...
describe("UserActivity", () => {
    ...
    it("should return all users' average stairs climbed for a day", () => {
        expect(userActivityAll.calculateAllAvgStairs('2019/06/12', userActivityAll)).to.equal(
            13);
    });

    it("should return all users' average steps taken for a day", () => {
        expect(
            userActivityAll.calculateAllAvgSteps("2019/06/12", userActivityAll)
        ).to.equal(2808.5);
    });

    it("should return all users' average minutes active for a day", () => {
        expect(
            userActivityAll.calculateAllAvgMin("2019/06/12", userActivityAll)
        ).to.equal(80);
    });
});