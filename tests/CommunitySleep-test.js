...
describe('CommunitySleep', function() {
  ...
  it('should be able to calculate how many hours slept and quality of sleep each day over the course of 7 days, for a single user', () => {
    expect(communitySleep.calculateSleepStatsWeek(39, "2019/08/11", "2019/08/17")).to.deep.equal([
      {"userID": 39, "date": "2019/08/11", "hoursSlept": 4.2, "sleepQuality": 2.3},
      {"userID": 39, "date": "2019/08/12", "hoursSlept": 5.5, "sleepQuality": 3.3},
      {"userID": 39, "date": "2019/08/13", "hoursSlept": 4.8, "sleepQuality": 1.0},
      {"userID": 39, "date": "2019/08/14", "hoursSlept": 4.8, "sleepQuality": 1.4},
      {"userID": 39, "date": "2019/08/15", "hoursSlept": 7.5, "sleepQuality": 1.4},
      {"userID": 39, "date": "2019/08/16", "hoursSlept": 6.8, "sleepQuality": 1.8},
      {"userID": 39, "date": "2019/08/17", "hoursSlept": 8.2, "sleepQuality": 3.8}
    ]);
    expect(communitySleep.calculateSleepStatsWeek(40, "2019/08/10", "2019/08/16")).to.deep.equal([
      {"userID": 40, "date": "2019/08/10", "hoursSlept": 4.1, "sleepQuality": 2.1},
      {"userID": 40, "date": "2019/08/11", "hoursSlept": 4.8, "sleepQuality": 2.0},
      {"userID": 40, "date": "2019/08/12", "hoursSlept": 3.4, "sleepQuality": 1.4},
      {"userID": 40, "date": "2019/08/13", "hoursSlept": 9.2, "sleepQuality": 3.3},
