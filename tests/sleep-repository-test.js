...
describe('SleepRepository', function() {
  ...
  it('should return all users for a selected date', () => {
    sleepRepo2 = new SleepRepository(sleepData2);

    expect(sleepRepo2.getUsersForADay("2019/06/15")).to.deep.equal([
      {
        "userID": 1,
        "date": "2019/06/15",
        "hoursSlept": 6.1,
  ...
  it('should sort users by hours slept', () => {
    sleepRepo2 = new SleepRepository(sleepData2);

    expect(sleepRepo2.sortUsersByHoursSlept("2019/06/15")).to.deep.equal([
      {
        "userID": 5,
        "date": "2019/06/15",
        "hoursSlept": 4.1,
